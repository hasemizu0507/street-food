...
from wineopener.models import Profile, wine, Station # [ REWRITE ]追加
pd.set_option('display.max_columns', 100)

from wineopener.scripts.make_cross_table import * # [ REWRITE ] クロス集計表を作成する。algorithm回ではCSVを使っていたがDjangoのデータベース(db.sqlite)から読み込む


class RecommendNew():
    def __init__(self):
        # self.df_estate = pd.read_csv("./data/wine.csv") # [ REWITE ]削除
        ...
        self.df_estate = pd.DataFrame.from_records(list(wine.objects.values() ))
