"""
Django settings for streetfood_proj project.
...
SECRET_KEY = '8ogf-00qoz!%-^25i-2pbip0($y@^2^1e7e)3--qf1qa4h+a=u'
...
# Application definition  # 追記(2021.08.28.23:59)
INSTALLED_APPS = [ 
...
ROOT_URLCONF = 'streetfood_proj.urls'
...
WSGI_APPLICATION = 'streetfood_proj.wsgi.application'
